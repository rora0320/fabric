...
import SelectedObject from "./tools/SelectedObject.jsx";
...
const Drawfabric = () => {
    ...
    const ComponentFromTool=()=>{
        switch (selectedTool) {
            ...
            case 'selectedObject':
                return <SelectedObject canvas={canvasInstance.current}/>
            default:
                return null;
        }
    }
    return (
        <div>
            ...
            <div>
                ...
                <button onClick={() => setSelectedTool('selectedObject')}>selectedObject Tool</button>
            </div>
            <h1>arrow</h1>
